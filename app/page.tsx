...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-background py-10 pb-12 sm:py-16">
        ...
        <div className="container relative z-10 max-w-4xl mx-auto px-6">
          <div className="max-w-xl space-y-6">
            ...
            <Link href="/posts">
              <Button size="lg" className="bg-[#5b73e1] hover:bg-[#4a5fc1] text-white rounded-md px-8 h-12 text-base font-semibold group mt-2">
                최근 기록 보기
              ...
              <Card key={post.id} className="group border-none shadow-sm hover:shadow-md transition-all overflow-hidden bg-card">
                <Link href={`/posts/${post.id}`}>
                  ...
                  <CardContent className="p-4 space-y-2">
                    ...
                    <div className="pt-3 flex items-center justify-end text-[11px] font-medium text-muted-foreground border-t">
      ...
      <section className="py-10 bg-background border-t pb-8">
        <div className="container max-w-4xl mx-auto px-6">
              ...
              <Link href={`/posts?cat=${item.slug}`} key={idx} className="block">
                <Card className="border-none bg-secondary/20 hover:bg-secondary/40 transition-colors group cursor-pointer shadow-none h-full">
                  <CardContent className="p-4 flex flex-col items-center text-center space-y-3">
                    <div className="p-2 bg-background rounded-xl shadow-sm group-hover:scale-110 transition-transform">
