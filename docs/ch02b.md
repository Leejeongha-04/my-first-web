...
☐
.github/copilot-instructions.md가 작성되었는가?
☐
import 경로가 올바른가?
☐
...
활동
7분
자기 코드와 참고 구현을 비교 — 다른 부분 3개 이상 찾기
3분
핵심 차이점 1~2개 정리
비교 포인트:
